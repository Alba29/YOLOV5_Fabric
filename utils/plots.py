...
class Annotator:
    ...
    def __init__(self, im, line_width=None, font_size=None, font='/home/wangshuo/miniconda3/envs/yolov5/lib/python3.8/site-packages/matplotlib/mpl-data/fonts/ttf/SimHei.ttf', pil=False, example='abc'):
